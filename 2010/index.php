<?php
    ...
    $pagetitles[] = 'Schedule';
    $pagelinks[] = 'program.php'; 
    
    $pagetitles[] = 'Organisers';
    $pagelinks[] = 'organisers.php'; 
    
    $pagetitles[] = 'Media Partners';
    $pagelinks[] = 'media.php'; 
    
    $pagetitles[] = 'Sponsors';
    $pagelinks[] = 'sponsors.php'; 
    
    $pagetitles[] = 'Photo Album';
    $pagelinks[] = 'photos.php'; 
    
    $pagetitles[] = 'Impressions';
    $pagelinks[] = 'impressions.php'; 
    
    $pagetitles[] = 'Press articles';
    $pagelinks[] = 'press.php'; 
